...
func New(data data.Data) *Presentor {
	return &Presentor{
		data: data,
	}
}

func (p *Presentor) GetDashboard(userId string) (template.HTML, error) {

	// user, err := p.data.GetUser(userId)

	return template.HTML("Hello World"), nil
}

func (p *Presentor) GetAdminDashboard() (template.HTML, error) {
...
func (p *Presentor) GetUserDashboard() (template.HTML, error) {
	return template.HTML(`
	<div class="pagetitle">
	<h1>Dashboard</h1>
	<nav>
