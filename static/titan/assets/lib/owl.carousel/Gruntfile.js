		...
		.initConfig({
			...
			sass: {
				docs: {
					options: {
						...
						includePaths: [ '<%= app.docs.src %>/static/assets/scss/', 'node_modules/foundation-sites/scss' ]
					},
					files: {
						'<%= app.docs.dest %>/static/assets/css/docs.theme.min.css': '<%= app.docs.src %>/static/assets/scss/docs.theme.scss'
					}
				},
				dist: {
					options: {
			...
			copy: {
				...
				distToDocs: {
					...
					cwd: 'dist/',
					src: [ '**/*.*' ],
					dest: '<%= app.docs.dest %>/static/assets/owlcarousel'
				},
				...
				srcToDocs: {
					...
					cwd: 'src/js',
					src: [ '**/*.js' ],
					dest: '<%= app.docs.dest %>/static/assets/owlcarousel/src'
				},

				docsAssets: {
					expand: true,
					cwd: '<%= app.docs.src %>/static/assets/',
					src: [ 'css/*.css', 'vendors/*.js', 'vendors/*.map', 'img/*.*', 'js/*.*' ],
					dest: '<%= app.docs.dest %>/static/assets/'
				},
			...
			watch: {
				...
				sassDocs: {
					files: [ '<%= app.docs.src %>/static/assets/**/*.scss' ],
					tasks: [ 'sass:docs' ]
				},
				sass: {
					files: [ 'src/**/*.scss' ],
				...
				jsDocs: {
					files: [ '<%= app.docs.src %>/static/assets/**/*.js' ],
